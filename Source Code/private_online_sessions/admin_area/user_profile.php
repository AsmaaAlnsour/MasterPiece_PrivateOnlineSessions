...
<h3 class=" control-h3"></h3>

</div><br>

<div class="form-group"><!-- form-group Starts -->

<h3 class=" control-h3">Full Name: <?php echo $admin_name; ?></h3>
</div><!-- form-group Ends -->
<br>
<div class="form-group"><!-- form-group Starts -->

<h3 class=" control-h3"> Email: <?php echo $admin_email; ?> </h3>
</div><!-- form-group Ends -->
<br>
<div class="form-group"><!-- form-group Starts -->

<h3 class=" control-h3"> Age: <?php echo $admin_age; ?> </h3>
</div><!-- form-group Ends -->
<br>

<div class="form-group"><!-- form-group Starts -->

<h3 class=" control-h3"> Phone:   <?php echo $admin_contact; ?></h3>
</div><!-- form-group Ends -->
<br>
...
<h3 class=" control-h3"> Address: <?php echo $admin_address; ?> </h3>
