...
<i class="fa fa-dashboard" ></i> Dashboard / View Suspended Teachers
...
WHERE  teachers.subject_id =subjects.id &&  subjects.grades_id =grades.id && teachers.delete_teacher='1'&& teachers.approval='1'&& teachers.suspend='0' ";
...
<a href="index.php?unsuspension_teacher=<?php echo $teacher_id; ?>">
