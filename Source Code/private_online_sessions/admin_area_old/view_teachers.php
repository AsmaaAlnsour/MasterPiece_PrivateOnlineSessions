...
<i class="fa fa-dashboard" ></i> Dashboard / View Teachers
...
WHERE  teachers.subject_id =subjects.id &&  subjects.grades_id =grades.id && teachers.delete_teacher='1'&& teachers.approval='1'&& teachers.suspend='1' ";
...
<a href="index.php?suspension_teacher=<?php echo $teacher_id; ?>">
