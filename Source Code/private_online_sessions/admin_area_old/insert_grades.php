...
<i class="fa fa-dashboard"></i> Dashboard / Insert Grades
...
<i class="fa fa-money fa-fw"></i> Insert Grades
...
<label class="col-md-3 control-label">Grade Title</label>
...
$insert_grade = "insert into grades (grade) values ('$grade_title')";
