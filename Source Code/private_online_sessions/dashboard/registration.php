...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $register->reg($_POST["email"],$_POST["name"],$_POST["pass"],$_POST["conpass"],$_POST["age"],$_POST["address"],$_POST["phone"]);
    ...
    <div class="container  ">
      <div class="row g-0 align-items-center">
        ...
        <span class="error">
            ...
            <span class="error">
                <?php
                if (isset($register->ageErr)) {
                    echo  $register->ageErr;
                }
                ?>
            </span>
                </div>
        ...
        <div class="col-4 mb-5 mb-lg-0">
          <img src="image.jpg" style="height: 800px;" class="w-350 rounded-4 shadow-4 mb-3" alt="" >
        </div>
      </div>
    </div>
    <!-- Jumbotron -->
