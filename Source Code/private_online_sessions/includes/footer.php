    ...
    >
      <div class="row pt-5">
        <div class="col-lg-4 col-md-6 mb-5">
          ...
          >
            ...
            <span class="text-white">TeachMe</span>
          </a>
          <p>
          Your TeachMe learning experience is grounded <br> in cutting edge
           cognitive science. With more <br>than two dozen distinct
            learning features to <br> help you achieve your goals.
          </p>
        ...
        <div class="col-lg-4 col-md-6 mb-5">
          ...
          <div class="d-flex flex-column justify-content-start">
            ...
            >
            <a class="text-white mb-2" href="teacher.php"
      ...
      >
        <p class="m-0 text-center text-white">
          &copy;
          <a class="text-primary font-weight-bold" href="index.php">TeachMe</a>.
          All Rights Reserved.
