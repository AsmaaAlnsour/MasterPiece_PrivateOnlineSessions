    ...
    <div class="container-fluid pt-5">
      <div class="container">
        <div class="text-center pb-2">
          ...
          <h1 class="mb-4">Classes for You and Your Kids</h1>
          <h1 class="mb-4">Choose your class!</h1>
        </div>
        <div class="row">
          <?php
        $query = "SELECT * FROM Grades where delete_grade='1'";
          ...
          <div class="col-lg-4 mb-5">
            <div class="card border-0 bg-light shadow-sm pb-2">
              <img style="height: 250px;" class="card-img-top mb-2" src="<?php if ($row['img']==null){echo 'img/about-2.jpg';}else{echo 'img/'.$row['img'];}  ?>" alt="" />
              <div class="card-body text-center">
                <h4 class="card-title"><?php echo $row['grade']; ?></h4>
                <p class="card-text">
              ...
              <div class="card-body text-center">
              <p class="card-text">
              If you belong to this class <br> choose the subject
                </p>
              </div>
              <a href="subject.php?grade_id=<?php echo $row['id']; ?>" class="btn btn-primary px-4 mx-auto mb-4">Choose Subject</a>
            </div>
          </div>
          <?php
                }}
